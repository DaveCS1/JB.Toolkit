    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            init: function (element) {
                ...
                if (unitsToAdd > 0) {
                    element.dateEnd.setDate(element.dateEnd.getDate() + ((unitsToAdd + screenWidthUnit) * daysPerUnit));
                }
                else {
                    element.dateEnd.setDate(element.dateEnd.getDate() + (screenWidthUnit * 3) * daysPerUnit);
                }
            },
            ...
            navigateTo: function (element, val) {
                ...
                var unitsToAdd = totalUnitsNeeded - totalUnitsNow;
                if (unitsToAdd > 0) {
                    element.dateEnd.setDate(element.dateEnd.getDate() + (unitsToAdd * daysPerUnit) + 2000);
                }
