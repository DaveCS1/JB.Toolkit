        ...
        function getViewerConfiguration() {
            return {
                ...
                secondaryToolbar: {
                    ...
                    emailButton: document.getElementById('secondaryEmail'),
                ...
                firstPagePromise.then(function (pdfPage) {
                    ...
                    Promise.all([storePromise, pageModePromise, openActionDestPromise]).then(
                        ...
                        function () {
                            ...
                            var viewerContainerO = document.getElementById("viewerContainer");

                            if (viewerContainerO)
                                viewerContainerO.scrollTop = 0;                        
...
/***/ (function (module, exports, __webpack_require__) {
        ...
        function getPDFFileNameFromURL(url) {
            ...
            if (FILENAME_OVERRIDE) {
                defaultFilename = FILENAME_OVERRIDE;
            }
                ...
                _createClass(PDFLinkService, [{
                    ...
                    value: function setHash(hash) {
                        ...
                        if (hash.includes('=')) {
                            ...
                            if ('filenameo' in params) {
                                FILENAME_OVERRIDE = params.filenameo;
                            }
            ...
            function () {
                ...
                _createClass(Toolbar, [{
                    ...
                    value: function _bindListeners() {
                        ...
                        items.email.addEventListener('click', function () {
                            eventBus.dispatch('email', {
                                source: self
                            });
                        });
