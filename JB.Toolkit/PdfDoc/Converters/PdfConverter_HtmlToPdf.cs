...
namespace JBToolkit.PdfDoc
{
    ...
    public partial class PdfConverter
    {
        public class HtmlToPdfConverter
        {
            ...
            static WkHEnvironment _e;

            public static WkHEnvironment PdfConvertEnvironment
            {
                get
                {
                    if (_e == null)
                    {
                        _e = new WkHEnvironment
                        {
            ...
            /// <param name="paperType">Paper type option</param>
            /// <param name="orientation">Orientation option</param>
            public static void ConvertToPdf(string html, string outputPath, PaperTypes paperType, Orientation orientation)
            {
                ConvertToPdf(
                         new PdfConvertDocument
                         {
            ...
            public static void ConvertToPdf(PdfConvertDocument document, PdfOutput output)
            {
                ConvertToPdf(document, null, output);
            }
            ...
            /// <returns></returns>
            public static PdfOutput ConvertToPdf(PdfConvertDocument document, WkHEnvironment environment, PdfOutput woutput)
            {
                if (environment == null)
            ...
            public static void GetHtmlFromUrlAndSaveToPdf(string url, string outputFilePath)
            {
                ConvertToPdf(new PdfConvertDocument { Url = url }, new PdfOutput { OutputFilePath = outputFilePath });
            }
