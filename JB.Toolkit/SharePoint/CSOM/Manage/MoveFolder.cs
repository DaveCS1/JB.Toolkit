...
namespace JBToolkit.SharePoint.CSOM
{
    ...
    {
        /// <summary>
        /// Move a folder from one SharePoint location to another
        /// 
        ...
        public static SharePointRequestResult MoveFolder(
            ...
            string fileLibraryDestinationPath)
        {
            ...
            try
            {
                ...
                MoveCopyUtil.MoveFolder(clientContext, clientContext.Url + "/" + fileLibrarySourcePath, clientContext.Url + "/" + fileLibraryDestinationPath, option);
            ...
            catch (Exception e)
            {
                if (e.Message.ToLower().Contains("file not found"))
                {
                    if (fileLibrarySourcePath.StartsWith("Documents") && fileLibraryDestinationPath.StartsWith("Documents"))
                    {
                        ...
                        return MoveFolder(clientContext, newSourcePath, newDistinationPath);
                    }
                }
