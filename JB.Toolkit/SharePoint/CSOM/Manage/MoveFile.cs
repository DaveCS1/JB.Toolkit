...
namespace JBToolkit.SharePoint.CSOM
{
    ...
    {
        /// <summary>
        /// Move a file from one SharePoint location to another
        /// 
        ...
        public static SharePointRequestResult MoveFile(
            ...
            string fileLibraryDestinationPath)
        {
            ...
            try
            {
                ...
                MoveCopyUtil.MoveFile(clientContext, clientContext.Url + "/" + fileLibrarySourcePath, clientContext.Url + "/" + fileLibraryDestinationPath, true, option);
            ...
            catch (Exception e)
            {
                if (e.Message.ToLower().Contains("file not found"))
                {
                    if (fileLibrarySourcePath.StartsWith("Documents") && fileLibraryDestinationPath.StartsWith("Documents"))
                    {
                        ...
                        return MoveFile(clientContext, newSourcePath, newDistinationPath);
                    }
                }
