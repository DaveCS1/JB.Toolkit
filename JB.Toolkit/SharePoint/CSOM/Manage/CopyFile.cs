...
namespace JBToolkit.SharePoint.CSOM
{
    ...
    public partial class Manage
    {
        ...
        public static SharePointRequestResult CopyFile(
            ...
            string fileLibraryDestinationPath)
        {
            ...
            try
            {
                ...
                MoveCopyUtil.CopyFile(clientContext, clientContext.Url + "/" + fileLibrarySourcePath, clientContext.Url + "/" + fileLibraryDestinationPath, true, option);
            ...
            catch (Exception e)
            {
                if (e.Message.ToLower().Contains("file not found"))
                {
                    if (fileLibrarySourcePath.StartsWith("Documents") && fileLibraryDestinationPath.StartsWith("Documents"))
                    {
                        ...
                        return CopyFile(clientContext, newSourcePath, newDistinationPath);
                    }
                }
