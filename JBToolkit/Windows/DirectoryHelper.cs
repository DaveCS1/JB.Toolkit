...
namespace JBToolkit.Windows
{
    ...
    public static class DirectoryHelper
    {
        ...
        /// <summary>
        /// Gets the root context path - I.e. working directory of application or website / service
        /// </summary>
        /// <returns>Root context path</returns>
        ...
        /// Gets the root context path - I.e. working directory of application or website / service
        /// </summary>
        /// <param name="contextType">Context type i.e. Application or website / service</param>
        /// <returns>Root context path</returns>
        public static string GetContextRoot(ContextType contextType)
        {
            switch (contextType)
            {
