...
namespace JBToolkit.FuzzyLogic
{
    ...
    /// <br /><br />
    /// Metaphone is a phonetic algorithm, published by Lawrence Philips in 1990, for indexing words by their English pronunciation.[1] 
    /// It fundamentally improves on the Soundex algorithm by using information about variations and inconsistencies in English spelling 
    /// and pronunciation to produce a more accurate encoding, which does a better job of matching words and names which sound similar. 
    /// <br /><br />
    /// Origin: https://github.com/tylerjensen/FuzzyStrings
    /// </summary>
    public static class DoubleMetaphoneAlgorithm
    {
